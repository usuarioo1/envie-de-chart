    ...
    return (
        <section className="rounded-3xl border border-[#F2B988] bg-gradient-to-br from-white via-[#F2B988]/10 to-[#ABA0F2]/10 p-8 shadow-sm">
            <div className="mb-8">
                ...
                <h2 className="text-3xl font-semibold text-gray-900 mb-3">Ateliers à venir</h2>
                <p className="text-sm text-gray-600">
                    Découvrez nos prochains ateliers de chant et réservez votre place (inscription bientôt disponible).
                </p>
            </div>
