        ...
        <div className="bg-gradient-to-b from-[#ABA0F2]/10 via-white to-[#F2B988]/20 min-h-screen">
            <div className="container mx-auto px-4 py-10">
                ...
                <div className="mb-12 p-8 bg-white rounded-3xl border-2 border-[#F2B988] shadow-lg">
                    <h2 className="text-3xl font-bold mb-4 text-slate-900 text-center tracking-wider">
                        N O U S &nbsp; S O M M E S &nbsp; T O U S &nbsp; C H A N T E U R S .
                    </h2>
                    
                    <h3 className="text-xl font-semibold mb-6 text-[#F25A38] text-center tracking-wide">
                ...
                {/* Formation 2 - Compact Format */}
                <div className="mb-12 p-6 bg-white rounded-2xl border border-[#F2B988] shadow-md">
                    <h2 className="text-2xl font-bold mb-2 text-slate-900 tracking-wide">
                        NOUS SOMMES TOUS CHANTEURS.
                    </h2>
                    
                    <h3 className="text-lg font-semibold mb-4 text-[#F25A38]">
                        NOTRE CORPS EST NOTRE INSTRUMENT DE MUSIQUE
                    </h3>
                    
                    <div className="mb-4 p-4 bg-[#ABA0F2]/10 rounded-lg">
                        <h4 className="text-lg font-bold mb-2 text-slate-900">OBJECTIF</h4>
                    ...
                    <div className="p-4 bg-[#F2B988]/10 rounded-lg">
                        <h4 className="text-lg font-bold mb-2 text-slate-900">CONTENU</h4>
                        <ul className="space-y-2">
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Reprendre les exercices sur les points du chanteur de Marie-Louise Aucher.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Travailler la parole sur la base des traditions orales et de la Psychophonie.</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Pratiquer un répertoire de chants simples et polyphonique</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="mt-4 text-center">
                        <button
                            onClick={() => openModal(2, 'NOUS SOMMES TOUS CHANTEURS - NOTRE CORPS EST NOTRE INSTRUMENT DE MUSIQUE')}
                            className="px-6 py-2 bg-[#F25A38] text-white font-semibold rounded-full hover:bg-[#732514] transition-colors shadow-md text-sm"
                        >
                            Soliciter plus d'information
                        </button>
                    </div>
                ...
                <div className="mb-12 p-6 bg-white rounded-2xl border border-[#F2B988] shadow-md">
                    <div className="mb-4 p-4 bg-gradient-to-r from-[#ABA0F2]/20 to-[#F2B988]/20 rounded-lg">
                    ...
                    <div className="mt-4 text-center">
                        <button
                            onClick={() => openModal(3, 'Chant Prénatal et Post-Natal')}
                            className="px-6 py-2 bg-[#F25A38] text-white font-semibold rounded-full hover:bg-[#732514] transition-colors shadow-md text-sm"
                        >
                            Soliciter plus d'information
                        </button>
                ...
                <div className="mb-12 p-6 bg-white rounded-2xl border border-[#F2B988] shadow-md">
                    ...
                    <div className="mt-4 text-center">
                        <button
                            onClick={() => openModal(4, 'Musique et Jeunes Enfants')}
                            className="px-6 py-2 bg-[#F25A38] text-white font-semibold rounded-full hover:bg-[#732514] transition-colors shadow-md text-sm"
                        >
                            Soliciter plus d'information
                        </button>
                ...
                <div className="mb-12 p-6 bg-white rounded-2xl border border-[#F2B988] shadow-md">
                    <div className="mb-4 p-4 bg-[#ABA0F2]/10 rounded-lg">
                        <h4 className="text-lg font-bold mb-2 text-slate-900">SUJETS</h4>
                        <ul className="space-y-2">
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Originalité et spécificités de la Psychophonie,</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Détail des choix pédagogiques,</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Construction d'une séance, rigueur et souplesse du pédagogue,</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Analyse d'une chanson.</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="p-4 bg-[#F2B988]/10 rounded-lg">
                        ...
                        <ul className="space-y-2">
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Mise en pratique de la pédagogique des points du chanteur,</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Animer une séance ou une séquence,</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Intégrer un chant par le "pompage" des résonances,</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Adapter et composer des exercices vocaux,</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">S'exercer à mener des séances d'éveil vocal.</span>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div className="mt-4 text-center">
                        <button
                            onClick={() => openModal(5, 'Psychophonie et Pédagogie')}
                            className="px-6 py-2 bg-[#F25A38] text-white font-semibold rounded-full hover:bg-[#732514] transition-colors shadow-md text-sm"
                        >
                            Soliciter plus d'information
                        </button>
                ...
                <div className="mb-12 p-6 bg-white rounded-2xl border border-[#F2B988] shadow-md">
                    ...
                    <div className="p-4 bg-gradient-to-r from-[#F2B988]/10 to-[#ABA0F2]/10 rounded-lg">
                        <ul className="space-y-2">
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">•</span>
                                <span className="text-sm text-slate-700">Découvrir les sons de base du djembé - Préparer la voix</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">•</span>
                                <span className="text-sm text-slate-700">Apprendre des chants</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">•</span>
                                <span className="text-sm text-slate-700">Les accompagner rythmiquement</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">•</span>
                                <span className="text-sm text-slate-700">Associer chant et djembé</span>
                            </li>
                        </ul>
                ...
                <div className="mb-12 p-6 bg-white rounded-2xl border border-[#F2B988] shadow-md">
                    <div className="p-4 bg-[#ABA0F2]/10 rounded-lg">
                        <p className="text-sm text-slate-700 leading-relaxed mb-3">
                        ...
                        <ul className="space-y-2 mb-4">
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">L'échelle des résonances</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Les constituants acoustiques de la voix</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">Les points du chanteur</span>
                            </li>
                            <li className="flex items-start gap-2">
                                <span className="text-[#F25A38] font-bold">-</span>
                                <span className="text-sm text-slate-700">La décontraction et la relaxation</span>
                            </li>
                        </ul>
                        <p className="text-sm text-slate-700 leading-relaxed">
