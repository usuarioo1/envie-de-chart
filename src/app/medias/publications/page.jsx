        ...
        <div className="bg-gradient-to-b from-[#ABA0F2]/10 via-white to-[#F2B988]/20 min-h-screen">
            <div className="container mx-auto px-4 py-10">
                ...
                <div className="space-y-12">
                    {publicationsData.books.map((book, index) => (
                        <div
                            key={book.id}
                        ...
                        >
                            {/* Book Grid: Image and Content */}
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
                                {/* Image Column */}
                                <div className={`flex items-center justify-center ${index === 1 ? 'lg:order-2' : ''}`}>
                                    <div className="w-full max-w-sm">
                                        <Image
                                            src={book.id === 1 ? libro1 : libro2}
                                            alt={book.title}
                                ...
                                <div className={index === 1 ? 'lg:order-1' : ''}>
                                    {/* Book Header */}
                                    <div className="mb-6 pb-6 border-b border-[#F2B988]">
                                    ...
                                    {/* About Author */}
                                    <div className="mb-6 p-4 bg-[#F2B988]/20 rounded-2xl">
                                    ...
                                    {/* Recommendation */}
                                    {book.recommendation && (
                                        <div className="mb-6 p-3 bg-[#ABA0F2]/10 rounded-xl border border-[#F2B988]">
                                            <div className="flex items-start">
                                                <svg
                                                    className="w-4 h-4 text-[#F25A38] mr-2 flex-shrink-0 mt-0.5"
                                                    fill="currentColor"
                                                    viewBox="0 0 20 20"
                                                >
                                    ...
                                    {/* Book Details & Order */}
                                    <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4 pt-4 border-t border-[#F2B988]">
                                        {/* Details Grid */}
                                        <div className="grid grid-cols-2 gap-3 flex-grow">
                                            ...
                                            <div>
                                                <p className="text-xs text-slate-600 mb-1">ISBN</p>
                                                <p className="font-semibold text-slate-900 text-sm">
                                                    {book.details.isbn}
                                                </p>
                                            </div>
                                            <div>
                                                ...
                                                <p className="font-bold text-[#F25A38] text-lg">
                                                    {book.details.price}
                                                </p>
                                            </div>
                                        </div>
                                        ...
                                        {book.order_link && (
                                            <a
                                                ...
                                                className="inline-flex items-center justify-center px-6 py-2 bg-[#F25A38] text-white rounded-full hover:bg-[#732514] transition-all whitespace-nowrap text-sm"
                                            >
                                                <svg
