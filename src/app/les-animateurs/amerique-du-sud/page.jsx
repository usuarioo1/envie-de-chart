...
export default function AmeriqueDuSudPage() {
    ...
    useEffect(() => {
        fetch('/api/animateurs?country=amerique-du-sud')
            .then(res => res.json())
            .then(data => {
    ...
    return (
        <div className="bg-gradient-to-b from-[#ABA0F2]/10 via-white to-[#F2B988]/20 min-h-screen">
            <div className="container mx-auto px-4 py-10">
                <h1 className="text-4xl font-bold mb-4 text-slate-900">Animateurs en Amérique du Sud</h1>
                ...
                {/* Animateurs desde Base de Datos */}
                <div className="mb-6">
