...
export default function EspanaPage() {
    ...
    useEffect(() => {
        fetch('/api/animateurs?country=espana')
            .then(res => res.json())
            .then(data => {
    ...
    return (
        <div className="bg-gradient-to-b from-[#ABA0F2]/10 via-white to-[#F2B988]/20 min-h-screen">
            <div className="container mx-auto px-4 py-10">
                <h1 className="text-4xl font-bold mb-4 text-slate-900">Animateurs en España</h1>
                <p className="text-lg text-slate-600 mb-8">Descubre nuestros animadores de canto prenatal en España.</p>
